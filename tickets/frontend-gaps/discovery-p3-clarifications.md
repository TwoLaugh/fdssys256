...
1. ✅ **No live progress signal** (discover §9 Q1). Status jumps QUEUED → RUNNING → terminal; the
   ...
   **DONE (2026-06-13, decision):** accepted as proposed; resolution recorded in `discover.md`
   §9 Q1.
2. ✅ **Skip is semantically empty** (discover §9 Q5). A skipped result stays a live system-catalogue
   ...
   page spec + HLD.
   **DONE (2026-06-13, ruling + doc):** ruled local-dismiss (the default). Pinned in
   `discover.md` §9 Q5 and `design/recipe-system.md` §entry points (Online discovery).
...
- [x] Each item: decision recorded inline; ruling for item 2 reflected in `discover.md` + HLD
