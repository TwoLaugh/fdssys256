 ...
 * AI_DELTA_APPLIED} is the delta pipeline; {@code REFRESH_TRIGGERED} is the POST {@code
 * /refresh-now} fire-and-forget call; {@code ROLLED_BACK} is the POST {@code /rollback} endpoint.
 */
