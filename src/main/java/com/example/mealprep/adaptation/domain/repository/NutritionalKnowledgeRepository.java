...
/**
 * Spring Data repository for {@link NutritionalKnowledgeEntry}. {@code public} so the in-module
 * {@code domain.service} package can inject it; cross-module isolation comes from the
 * (01f-shipping) {@code ModuleBoundaryArchTest}. Verbatim from {@code lld/adaptation-pipeline.md}
 * lines 470-476.
 *
 ...
 */
public interface NutritionalKnowledgeRepository
    extends JpaRepository<NutritionalKnowledgeEntry, UUID> {
