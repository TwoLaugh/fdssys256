 ...
 * starting default the user can override. {@code bmr} and {@code ageGroup} are surfaced so the UI can
 * explain where the numbers came from. {@code micros} is {@code nutrientKey → RDA/AI floor} from the
 * matched {@code (ageGroup, sex)} DRI band.
 */
