 ...
 * → "3"), which is meaningless once canonical keys merge ingredients that appear in different
 * units.
 *
...
public final class IngredientUnitConverter {
  ...
  private static final Map<String, Double> VOLUME_ML =
      Map.ofEntries(
          Map.entry("tsp", 4.93),
          Map.entry("tbsp", 14.79),
          Map.entry("cup", 236.6),
          Map.entry("ml", 1.0),
          Map.entry("l", 1000.0),
          Map.entry("pint", 473.18),
          Map.entry("quart", 946.35),
          Map.entry("gallon", 3785.41),
          Map.entry("fl oz", 29.57));
  ...
  private static final Map<String, Double> DENSITY =
      Map.ofEntries(
          ...
          Map.entry("cocoa", 0.41),
          Map.entry("oats", 0.41),
          Map.entry("rice", 0.85),
          Map.entry("salt", 1.2),
          Map.entry("soy sauce", 1.1),
          Map.entry("vinegar", 1.01),
          Map.entry("wine", 0.99),
          Map.entry("juice", 1.04),
          Map.entry("broth", 1.0),
          Map.entry("stock", 1.0),
          Map.entry("water", 1.0));
   ...
   */
  public static Optional<BigDecimal> toGrams(
      BigDecimal quantity, String unit, String ingredientKey) {
    ...
    return Optional
        .empty(); // count / no-unit / unrecognised → keep raw, match a count pack instead
  }
