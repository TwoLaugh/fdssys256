...
/**
 * Cross-module SPI for the NUTRITION destination. The real adapter ships in {@code
 * tickets/feedback/01g} ({@code feedback.bridge.NutritionFeedbackBridgeImpl}); until then the Noop
