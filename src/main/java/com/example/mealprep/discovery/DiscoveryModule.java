 ...
 * (planner cold-start, recipe user-initiated) inject this rather than reaching into
 * {@code domain.service.*} directly.
 *
 * <p>Mirrors {@code RecipeModule} / {@code AiModule} / {@code PreferenceModule}: thin, no business
 * logic, just bean references. 01a wires it against an empty-interface stub
 * ({@link com.example.mealprep.discovery.domain.service.internal.DiscoveryServiceStub}); 01b
 * appends methods to the interfaces + replaces the stub with {@code DiscoveryServiceImpl}.
 */
@Component
