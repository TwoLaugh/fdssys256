...
/**
 * Thrown by the member-admin endpoints when the target {@code memberId} doesn't exist OR exists in
 * a different household than the caller's. The latter case is collapsed into "not found" to avoid
