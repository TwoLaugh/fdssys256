...
class IngredientUnitConverterTest {
  ...
  void weight_units_are_exact() {
    assertThat(grams("1", "lb", "beef")).isCloseTo(453.59, org.assertj.core.data.Offset.offset(0.1));
    assertThat(grams("8", "oz", "cheddar cheese")).isCloseTo(226.8, org.assertj.core.data.Offset.offset(0.5));
  ...
  void volume_uses_per_ingredient_density() {
    ...
    assertThat(grams("2", "tbsp", "olive oil")).isCloseTo(27.2, org.assertj.core.data.Offset.offset(0.3));
    // 1 cup flour = 236.6 * 0.53 ≈ 125 g
    assertThat(grams("1", "cup", "all-purpose flour")).isCloseTo(125.4, org.assertj.core.data.Offset.offset(1.0));
    // 1 cup water = 236.6 g (default density 1.0)
    assertThat(grams("1", "cup", "water")).isCloseTo(236.6, org.assertj.core.data.Offset.offset(0.5));
  }
  ...
  void unknown_volume_ingredient_falls_back_to_water_density() {
    ...
    assertThat(grams("1", "tbsp", "mystery sauce")).isCloseTo(14.79, org.assertj.core.data.Offset.offset(0.1));
  }
